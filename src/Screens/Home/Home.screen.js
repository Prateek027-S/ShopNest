...
import { Modal, View, FlatList, ScrollView, Button, Image } from "native-base";

const HomeScreen = () => {
  const { items, selectedItem, modalVisible, handleItemClick, handleCloseDetails } = useHomeController();
